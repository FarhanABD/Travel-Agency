                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="datepicker1" type="date" name="tour_start_date" class="form-control" value="{{ old('tour_start_date') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Tour End Date *</label>
                                            <input id="datepicker2" type="date" name="tour_end_date" class="form-control" value="{{ old('tour_end_date') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Booking End Date *</label>
                                            <input id="datepicker3" type="date" name="booking_end_date" class="form-control" value="{{ old('booking_end_date') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
